...
const services: ServiceData[] = [
  {
    icon: <FaHome className=" text-primar text-4xl" />,
    title: "Modern Homes",
    description:
          ...
          <div className="lg:w-2/4 w-full">
            <div className="flex flex-col items-start">
              ...
              <p className="text-gray-600 text-lg lg:text-base leading-relaxed mb-4">
                At The Hamptons, we prioritize your comfort, security, and
                satisfaction. Our properties are strategically located,
